      ...
      <!-- Header Navbar: style can be found in header.less -->
        ...
        <nav class="navbar blue-bg navbar-static-top"> 
          ...
          <div class="pull-left">
              ...
              <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="{{ asset('user-avater.webp') }}" class="user-image" alt="User Image"> <span class="hidden-xs">{{ Auth::user()->full_name }}</span> </a>
